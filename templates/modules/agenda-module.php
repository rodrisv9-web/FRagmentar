...
<div class="agenda-module-container" id="agenda-module" data-professional-id="<?php echo esc_attr($employee_id); ?>">
    ...
    <div id="appointment-modal" class="modal-overlay hidden">
        <div class="modal-content">
            ...
            <button id="close-modal-btn" class="close-btn">Cerrar</button>
        </div>
    </div>
    ...
    <!-- <-- INICIO DEL CAMBIO: Proyecto Chocovainilla - Paso 3.1 --> -->
    <div id="logbook-modal" class="modal-overlay hidden">
        <div class="modal-content">
            <div class="modal-header">
                <h3 id="logbook-modal-title" class="modal-title">Registrar Visita en Bitácora</h3>
                <button id="logbook-close-btn" class="modal-close-btn">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <form id="logbook-form">
                <input type="hidden" id="logbook-appointment-id" name="appointment_id">
                <input type="hidden" id="logbook-pet-id" name="pet_id">
                <input type="hidden" id="logbook-professional-id" name="professional_id">

                <div class="modal-body">
                    <p>Registrando visita para: <strong id="logbook-pet-name-display"></strong></p>
                    <div class="form-group">
                        <label for="logbook-title" class="form-label">Título / Motivo de la Visita *</label>
                        <input type="text" id="logbook-title" name="title" class="form-input" required placeholder="Ej: Vacunación Anual, Consulta de seguimiento">
                    </div>
                    <div class="form-group">
                        <label for="logbook-description" class="form-label">Diagnóstico / Observaciones</label>
                        <textarea id="logbook-description" name="description" rows="3" class="form-input form-textarea"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="logbook-treatment" class="form-label">Tratamiento / Procedimiento Realizado</label>
                        <textarea id="logbook-treatment" name="treatment" rows="3" class="form-input form-textarea"></textarea>
                    </div>
                </div>
                <div class="form-actions">
                    <button type="button" id="logbook-skip-btn" class="btn-secondary">Completar sin Registrar</button>
                    <button type="submit" id="logbook-save-btn" class="btn-primary">
                        <i class="fas fa-save"></i> Guardar y Completar
                    </button>
                </div>
            </form>
            <script>
                console.log("✅ Chocovainilla: Nuevo HTML del Modal de Bitácora cargado en el DOM.");
            </script>
        </div>
    </div>
    ...
    <!-- <-- FIN DEL CAMBIO: Proyecto Chocovainilla - Paso 3.1 --> -->
</div>
